<?php
	...
	function getComments(){
		include('connect.php');
		$queryComments = "SELECT tbl_comments.comment, tbl_films.film_id, tbl_comments.film_id
FROM tbl_comments
INNER JOIN tbl_films WHERE tbl_comments.film_id=tbl_films.film_id";
		$runComments = mysqli_query($link, $queryComments);
